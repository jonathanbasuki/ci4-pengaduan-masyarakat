...
<body>
  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="<?= base_url('/'); ?>" class="logo d-flex align-items-center fs-3">
        AdaKami
      </a>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="getstarted scrollto" href="<?= base_url(); ?>/<?= (logged_in()) ? 'dashboard' : 'login'; ?>"><?= (logged_in()) ? 'Dashboard' : 'Login'; ?></a></li>
        </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Ada Kendala Dalam Beraktifitas?</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Tim kami akan siap menanggapi aduan Anda.</h2>
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="<?= base_url(); ?>/assets/images/home/hero-img.png" class="img-fluid" alt="">
        </div>
      </div>
    </div>
