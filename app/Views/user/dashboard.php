		...
		<div class="alert">
			...
			<p class="text-medium">
				<?php if (count($data['aduan']) > 0): ?>
					Anda memiliki <a href="<?= base_url('/aduan'); ?>" style="text-decoration: underline;"><?= count($data['aduan']); ?> keluhan</a> yang belum terselesaikan.
				<?php endif; ?>
				<?php if (count($data['aduan']) == 0): ?>
					Anda belum menyampaikan keluhan.
				<?php endif; ?>
			</p>
		</div>
	</div>
